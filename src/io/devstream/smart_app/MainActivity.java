...
public class MainActivity extends Activity {
	...
	public void callActivity(View v) {
		...
		case R.id.profile:
			...
			break;
		case R.id.clinics:
			Intent clinics = new Intent(MainActivity.this,
					ClinicsActivity.class);
			startActivity(clinics);
			break;
		case R.id.post:
			Intent postnatal = new Intent(MainActivity.this,
					PostnatalActivity.class);
			startActivity(postnatal);
			break;
		case R.id.userAntenatal:
			Intent anteNatal = new Intent(MainActivity.this,
					AntenatalActivity.class);
			startActivity(anteNatal);
			break;
		case R.id.clin:
			Intent clinicDateIntent = new Intent(MainActivity.this,
					ClinicDateActivity.class);
			startActivity(clinicDateIntent);
			break;
		case R.id.apt:
			Intent aptIntent = new Intent(MainActivity.this,
					AppointmentsActivity.class);
			startActivity(aptIntent);
			break;
		case R.id.serviceOption:
			Intent options = new Intent(MainActivity.this,
					ServiceOptionsActivity.class);
		...
		case R.id.calendarAntenatal:
			Intent calendarAnte = new Intent(MainActivity.this,
					CalendarAntenatalClinicViewActivity.class);
			startActivity(calendarAnte);
			break;
		case R.id.appAntenatal:
			Intent appAnte = new Intent(MainActivity.this,
					AppoimtmentAntenatalViewActivity.class);
